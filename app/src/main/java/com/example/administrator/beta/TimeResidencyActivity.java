...
public class TimeResidencyActivity extends AppCompatActivity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        Intent intent = new Intent(TimeResidencyActivity.this, SecondActivity.class);
        TimeResidencyActivity.this.startActivity(intent);
        finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_time_residency);
        linearLayout = (LinearLayout)findViewById(R.id.time_residency);
        progressBar = (ProgressBar)findViewById(R.id.progressbar_time_residency);
...
//            }
        ...
        mwebview.loadUrl("http://zyhdbw.cn/Personal/mobile/index4.html");//"http://zyhdbw.cn/RES/password_find_android.html");
        ...
        mwebview.setWebViewClient(new WebViewClient(){
            ...
            public void onPageFinished(WebView view, String url) {
                Toast.makeText(TimeResidencyActivity.this,"页面加载完成！",Toast.LENGTH_SHORT).show();
