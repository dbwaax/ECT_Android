...
public class ResidencyActivity extends AppCompatActivity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        Intent intent = new Intent(ResidencyActivity.this, SecondActivity.class);
        ResidencyActivity.this.startActivity(intent);
        finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout = (LinearLayout)findViewById(R.id.residency);
        progressBar = (ProgressBar)findViewById(R.id.progressbar_residency);
...
//            }
        ...
        mwebview.loadUrl("http://zyhdbw.cn/Personal/mobile/index3.html");//"http://zyhdbw.cn/RES/password_find_android.html");
        ...
        mwebview.setWebViewClient(new WebViewClient(){
            ...
            public void onPageFinished(WebView view, String url) {
                Toast.makeText(ResidencyActivity.this,"页面加载完成！",Toast.LENGTH_SHORT).show();
