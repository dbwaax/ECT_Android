...
public class password_find_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_password_find_);
        linearLayout = (LinearLayout)findViewById(R.id.llayout2);
        ...
        mwebview.loadUrl("http://zyhdbw.cn/RES/password_find_android.html");
        ...
        mwebview.setWebViewClient(new WebViewClient(){
            ...
            public void onPageFinished(WebView view, String url) {
                Toast.makeText(password_find_Activity.this,"页面加载完成！",Toast.LENGTH_SHORT).show();
        ...
        mwebview.setWebChromeClient(new WebChromeClient(){
            ...
            public boolean onJsAlert(WebView view, String url, String message, final JsResult result) {
                new AlertDialog.Builder(password_find_Activity.this)
                        .setTitle("zyhdbw.cn")
                        .setMessage(message)
            ...
            public boolean onJsPrompt(WebView view, String url, String message, String defaultValue, final JsPromptResult result) {
                final EditText et = new EditText(password_find_Activity.this);
